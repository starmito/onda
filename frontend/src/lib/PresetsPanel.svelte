...
<style>
  ...
  .btn-execute-large { width: 100%; padding: 14px; background: #00d4ff; color: #0a0a14; border: none; border-radius: 8px; font-size: 17px; font-weight: bold; cursor: pointer; margin-bottom: 12px; transition: background 0.2s; }
  .btn-execute-large:hover { background: #00b8e6; }
  ...
  .progress-status { font-weight: bold; color: #00d4ff; text-transform: uppercase; font-size: 13px; }
  ...
  .progress-bar-fill { height: 100%; background: linear-gradient(90deg, #00d4ff, #4caf50); border-radius: 4px; transition: width 0.3s ease; }
